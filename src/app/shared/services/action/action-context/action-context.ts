...
import { ActionStrategy } from '../action-strategy/action-strategy';
import { ChangeThemeStrategy } from '../change-theme-strategy/change-theme-strategy';
import { ChangeTitleStrategy } from '../change-title-strategy/change-title-strategy';
